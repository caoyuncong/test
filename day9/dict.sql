...
INSERT INTO db_dict.sentence VALUES (NULL, 'We achieved within seven months an agreement that has stood the
test of time.', '我们在七个月内完成一项协议,而且经受住了时间的考验。', 1);
INSERT INTO db_dict.sentence VALUES (NULL, 'Our test flight was to discover the bugs in the new plane.',
                                     '试验飞行是为了发现新飞机有何毛病。', 1);
INSERT INTO db_dict.sentence VALUES (NULL, 'By doing so, you can test the strength of steel.',
                                     '这样做,你可以试验一下钢的强度。', 2);
INSERT INTO db_dict.sentence VALUES (NULL, 'Listening to his continuous stream of empty chatter
 really tested my patience.', '听他那没完没了的连篇空话对我的耐心真是一大考验。', 2);
